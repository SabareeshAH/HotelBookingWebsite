      ...
      <div>
        ...
        <div className="hotelWrapper">
          ...
          <span className="hotelDistance">
            Excellent Location - {data.distance} metres from the Center of city
          </span>
          <span className="hotelPriceHighlight">
            Book a stay over Rupees {data.cheapestPrice} at this property and get a free airport taxi
          </span>
          ...
          <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                <h2>
                  <b>Rupees {days*data.cheapestPrice*options.room}</b> ({days} nights)
                </h2>
